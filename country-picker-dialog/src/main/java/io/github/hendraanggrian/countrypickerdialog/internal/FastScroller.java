...
public class FastScroller {
    ...
    public FastScroller(Context context, FastScrollRecyclerView recyclerView, AttributeSet attrs) {
        ...
        mTrack.setColor(ContextCompat.getColor(context, android.R.color.transparent));
        mThumb.setColor(Utils.getThemeColor(context, R.attr.colorAccent));
        mPopup.setBgColor(Utils.getThemeColor(context, R.attr.colorAccent));
        mPopup.setTextColor(ContextCompat.getColor(context, android.R.color.white));
        mPopup.setTextSize(Utils.toPixels(context.getResources(), 14));
        mPopup.setBackgroundSize(Utils.toPixels(context.getResources(), 48));
