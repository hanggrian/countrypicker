...
import com.hendraanggrian.material.countrypicker.CountryPickerDialog
import com.hendraanggrian.material.countrypicker.CountryPickerSheetDialog
import com.hendraanggrian.material.countrypicker.FlagDisplay
import com.hendraanggrian.material.countrypicker.NameDisplay
...
class MainFragment : PreferenceFragmentCompat() {
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        showSheetPreference.setOnPreferenceClickListener {
            val context = requireContext()
            CountryPickerSheetDialog.Builder(context)
                .setFlagDisplay(preferences.flagDisplay)
                .setNameDisplay(preferences.nameDisplay)
                .setOnSelectedListener {
                    Snackbar.make(requireView(), it.getName(context), Snackbar.LENGTH_SHORT).show()
